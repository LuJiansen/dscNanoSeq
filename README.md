...
For allele-specific peaks analysie, please refer to [dscNanoSeq_haplotype_phasing.smk](pipeline/dscNanoSeq_haplotype_phasing.smk) and the example ASP analysis notebook [dscNanoATAC_GM12878_allelic_specific.ipynb](pipeline/dscNanoATAC_GM12878_allelic_specific.ipynb)
